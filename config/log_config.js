  ...
  switch (levelName) {
    case 'info':
      generateLogObj = {
        ...
        transports: [
          ...
          new transports.File({
            filename: '/var/logs/defcon_onedefcon_one_info.log',
            level: 'info'
          })
        ]
      };
    ...
    case 'error':
      generateLogObj = {
        ...
        transports: [
          new transports.File({
            filename: '/var/logs/defcon_onedefcon_one_error.log',
            level: 'error'
          })
        ]
      };
    ...
    case 'debug':
      generateLogObj = {
        ...
        transports: [
          ...
          new transports.File({
            filename: '/var/logs/defcon_onedefcon_one_debug.log',
            level: 'debug'
          })
        ]
      };
    ...
    case 'warn':
      generateLogObj = {
        ...
        transports: [
          ...
          new transports.File({
            filename: '/var/logs/defcon_onedefcon_one_warn.log',
            level: 'warn'
          })
        ]
      };
    ...
    case 'trace':
      generateLogObj = {
        ...
        transports: [
          ...
          new transports.File({
            filename: '/var/logs/defcon_onedefcon_one_trace.log',
            level: 'trace'
          })
        ]
      };
    ...
    case 'crit':
      generateLogObj = {
        ...
        transports: [
          new transports.File({
            filename: '/var/logs/defcon_onedefcon_one_crit.log',
            level: 'crit'
          })
        ]
      };
    ...
    default:
      generateLogObj = {
        ...
        transports: [
          new transports.File({
            filename: '/var/logs/defcon_onedefcon_one_fatal.log',
            level: 'fatal'
          })
        ]
      };
